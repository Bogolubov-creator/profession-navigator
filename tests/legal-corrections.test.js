...
test('Редакционная памятка сохраняет происхождение после добавления норм',()=>{const n=applyLegalCorrection({...m,contentOrigin:'editorial'},p);assert.equal(n.contentOrigin,'editorial')});
